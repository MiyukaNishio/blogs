...
Here `serviceName`'s value is the name of the Web Service Client you're are configuring. This name comes from your `@WebServiceClient(serviceName=<client service name>` annotated stub class for managed clients.
